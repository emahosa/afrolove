...
BEGIN
    ...
    -- 4. Check if the user has enough credits from the 'profiles' table, handle NULL case
    SELECT COALESCE(credits, 0) INTO user_credits FROM public.profiles WHERE id = current_user_id;
