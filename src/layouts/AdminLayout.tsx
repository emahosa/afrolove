...
const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      {/* Admin Header */}
      <header className="bg-primary text-primary-foreground shadow-md px-4 sm:px-6 lg:px-8">
      ...
      <footer className="bg-background border-t border-border px-4 sm:px-6 lg:px-8 py-4 text-center text-sm text-muted-foreground">
