                        ...
                        >
                          {genres.map((genre) => (
                            <div key={genre.id} className="space-y-1">
                              ...
                              <Label
                                htmlFor={genre.id}
                                className="flex flex-col items-center justify-between rounded-md border-2 border-muted bg-card p-4 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-blue-500 peer-data-[state=checked]:bg-blue-50 peer-data-[state=checked]:text-blue-900 cursor-pointer transition-all duration-200 hover:scale-105"
                              >
                                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-muted peer-data-[state=checked]:bg-blue-100 mb-2 transition-colors duration-200">
