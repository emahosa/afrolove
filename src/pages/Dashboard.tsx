...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchDashboardStats = async () => {
      ...
      try {
        ...
        // Get total songs generated by user
        const { count: totalSongs } = await supabase
          .from('songs')
          .select('*', { count: 'exact', head: true })
          .eq('user_id', user.id);

        // Get songs currently processing
        ...
        setDashboardStats({
          songsGenerated: totalSongs || 0,
          songsProcessing: processingSongs || 0,
          songsThisMonth: monthSongs || 0
        });
  ...
  const stats = [
    ...
    },
    {
      ...
      value: loadingStats ? "..." : dashboardStats.songsGenerated,
      icon: Music,
    ...
    {
      title: "Processing",
      value: loadingStats ? "..." : dashboardStats.songsProcessing,
      icon: Clock,
    ...
    {
      title: "This Month",
      value: loadingStats ? "..." : dashboardStats.songsThisMonth,
      icon: TrendingUp,
