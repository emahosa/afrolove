...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-white data-[state=active]:text-melody-primary data-[state=active]:shadow-lg",
      "data-[state=active]:border data-[state=active]:border-melody-primary/30",
      "text-muted-foreground hover:text-foreground",
      "transform hover:translate-y-[-1px] active:translate-y-0",
      "relative overflow-hidden",
      "before:absolute before:inset-0 before:bg-gradient-to-r before:from-melody-primary/5 before:to-melody-secondary/5",
